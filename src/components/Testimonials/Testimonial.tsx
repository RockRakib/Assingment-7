      ...
      <div className="relative w-full glide-08">
        ...
        >
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            {providerTestimonials?.map((test: Testimonial) => (
              <li key={test._id}>
                  ...
                  <div className="overflow-hidden ">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        ...
                        <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-gray-500">
                          <span
                          ...
                          <div className="flex items-center gap-4 pt-4 text-sm text-left text-white">
