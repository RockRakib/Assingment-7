          ...
          <div>
            <ul className="flex flex-1 flex-col gap-1 py-3">
              <li className="px-3">
                <a
                  href="#"
                  className="flex items-center gap-3 rounded p-3 text-slate-700 transition-colors hover:bg-gray-50 hover:text-gray-500 focus:bg-gray-50 aria-[current=page]:bg-gray-50 aria-[current=page]:text-gray-500 "
                >
